...
# make sure the dashes/ commas / spaces etc in the format match the data
#challenge
...
# in the github under resources, we can also download data from this class 
# instead of doing a long call
...
#string ^ is the same length as the # of columns
