...
# need return function to have it show the number
m<- f_to_k(72)

# source()ing functions ---------------------------------------------------
source("scripts/8_functions.R")
...
# and the name of a country (e.g. "Afghanistan"), and plots a time series of 
#the country’s population. The return value from the function should be a 
#ggplot object. Note: It is often easier to modify existing code than to start 
#from scratch. To start out with one plot for a particular country, figured out 
#what you need to change for each iteration (these will be your arguments), and 
#then wrap it in a function.


challenge <- function(cntry){
  d <- gapminder%>%
